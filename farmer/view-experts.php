...
$selected = mysqli_query($conn, "SELECT * FROM experts");
//$i = 1;
?>
<head>
            ...
            <div class="b-container">
              <div class="row">
               ...
               while ($personrow = mysqli_fetch_array($selected)) {
                $personid = $personrow['eid'];
                $name = $personrow['name'];
                $specifications = $personrow['specifications'];
                  ...
                  <div class='panel-body'>
                    <!-- <div class="row">
                     ...
                     <div class="col-sm-10">
                      &nbsp;&nbsp;&nbsp;&nbsp;
                      <?php
                      echo "Experts No: $personid"; echo "<br />\n";
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">Expert Form</h4>
            </div>
            <div class="modal-body">
              <form method="POST" action="process.php">
                <div class="col-sm-10">
                  ...
                  <p><b>Last Name: </b><?php echo $personrow['specifications']; echo "<br />\n"; ?></p> 
                  <p><b> Address: </b><?php echo $personrow['address']; ?></p>
                </p>
                <p><b> Contact: </b><?php echo $personrow['phonenumber']; ?></p>
                <p><b> Contact: </b><?php echo $personrow['faxnumber']; ?></p>
                ...
                <input type="hidden" id="form_id" name="pid" value="<?php echo $personrow['eid']; ?>"/>
