...
$selected = mysqli_query($conn, "SELECT * FROM customers");
//$i = 1;
?>
<head>
            ...
            <div class="b-container">
              <div class="row">
               ...
               while ($personrow = mysqli_fetch_array($selected)) {
                $personid = $personrow['cid'];
                $fname = $personrow['firstname'];
                $lname = $personrow['lastname'];
                ...
                <div class='panel-body'>
                    <!-- <div class="row">
                     ...
                     <div class="col-sm-6">
                      &nbsp;&nbsp;&nbsp;&nbsp;
                      <?php
                      echo "Customer No: $personid"; echo "<br />\n";
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="POST" action="process.php">
                <div class="col-sm-10">
                  <p><h5><b>customer Image: </b></h5><img src="user_images/<?php echo $personrow['productImage']; ?>" class="img-rounded" width="150" height="100" /></p>

                  <p><b>Last Name: </b><?php echo $personrow['lastname']; echo "<br />\n"; ?></p> <p><b> Address: </b><?php echo $personrow['address']; ?></p>
                </p>
                <p><b> Contact: </b><?php echo $personrow['phonenumber']; ?></p>
