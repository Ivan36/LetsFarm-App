    ...
    <div class="userId"><span style="text-transform:uppercase; text-align: center;color: green; font-size: 18px;">Admin Dashboard</span>
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                <p style="background-color: #eee;margin-right: 5%;">
                    <?php
                ...
                <li>
                   ...
                   <ul class="collapse list-unstyled" id="pageSubmenu">
                        <li>
                            <a href="farmers.php"><i class="fas fa-fw fa-plus"></i> Add Farmers</a>
                        </li>
                        <li>
                            <a href="customers.php"><i class="fas fa-fw fa-plus"></i> Add Customers</a>
                        </li>
                          <li>
                            <a href="saccos.php"><i class="fas fa-fw fa-plus"></i> Add Saccos</a>
                        </li>
                          <li>
                            <a href="experts.php"><i class="fas fa-fw fa-plus"></i> Add Experts</a>
                        </li>
                        <li>
