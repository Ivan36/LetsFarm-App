<?php 
// $con=mysqli_connect("localhost","root","","lets_farm_db");
// session_start();
...
// }
// $id  = $_SESSION['uid'];
// $ask = "SELECT * FROM users WHERE uid = '$uid'";
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="../login.php" onclick="are you sure you want to leave" style="color: gold;"><i class="fas fa-fw fa-power-off"></i> Logout</a></li>
        </ul>
      </div>
    </div>
  </nav>
