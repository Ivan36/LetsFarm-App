...
<div class="content" >
 ...
 <!--  <div class="jumbotron bg-success">
   ...
   <div class="row" style="margin-left: 2%; margin-top: 5%;">
    <div class="b-container">
      <hr>
      <h2 class="form-signin-heading" style = "color:green;text-align: center;">CURRENT SACCO USING THE SYSTEM</h2><hr />
      <button class="btn btn-info" type="button" id="btn-add" onclick="href="register.php""><i class="fas fa-fw fa-plus-circle"></i> &nbsp; ADD SACCO</button>
      ...
      <div class="content-loader">
        <table cellspacing="0" width="100%" id="example" class="display nowrap table table-striped table-bordered table-hover table-responsive">
          ...
          <tbody>
            ...
            $stmt = $DB_con->prepare("SELECT * FROM sacco ORDER BY sid");
            $stmt->execute();
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
              ...
              <tr>
                ...
                <td align="center">
                  <a class="btn btn-sm btn-default" style="color: green;" href="activate.php?edit_id=<?php echo $row['sid']; ?>" title="click to activate" onclick="return confirm('sure to activate account = <?php echo $row['sid']; ?> ?')">
                    <i class="fas fa-fw fa-edit"></i>
                  Activate</a>
                  &nbsp;
                  <a class="btn btn-sm btn-default" style="color: red;" name="inactive" href="deleteuser.php?delete_id=<?php echo $row['sid']; ?>" title="click for Deactivate" onclick="return confirm('sure to Deactivate account = <?php echo $row['sid']; ?> ?')">
