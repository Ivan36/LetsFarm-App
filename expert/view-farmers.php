...
$selected = mysqli_query($conn, "SELECT * FROM farmers");
//$i = 1;
?>
<head>
            ...
            <div class="b-container">
              <div class="row">
               ...
               while ($personrow = mysqli_fetch_array($selected)) {
                $personid = $personrow['fid'];
                $name = $personrow['first_name'];
                $specifications = $personrow['last_name'];
                  ...
                  <div class='panel-body'>
                    <!-- <div class="row">
                     ...
                     <div class="col-sm-10">
                      &nbsp;&nbsp;&nbsp;&nbsp;
                      <?php
                      echo "Farmer No: $personid"; echo "<br />\n";
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">Farmer Form</h4>
            </div>
            <div class="modal-body">
              <form method="POST" action="process.php">
                <div class="col-sm-10">
                  ...
                  <p><b>Last Name: </b><?php echo $personrow['last_name']; echo "<br />\n"; ?></p> 
                  <p><b> Address: </b><?php echo $personrow['Address']; ?></p>
                </p>
                <p><b> Contact: </b><?php echo $personrow['phone_number']; ?></p>
                ...
                <input type="hidden" id="form_id" name="pid" value="<?php echo $personrow['fid']; ?>"/>
